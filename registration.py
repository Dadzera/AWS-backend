...
def lambda_handler(event, context):
    ...
    s3_client.put_item(TableName='UserTable',Item={"username":{'S':res['email']}, "name":{'S':res['name']},'surname':{'S':res['surname']}, 'password':{'S':res['password']},'password2':{'S':res['password2']},'gender':{'S':res['gender']},'country':{'S':res['country']},'city':{'S':res['city']},'birth':{'S':res['birth']}, 'like':{'S':" "},'bio':{'S':' '}})
    return {
        'statusCode': 200,
